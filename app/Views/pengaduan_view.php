...
<?= $this->section('title')?>
<i class="fas fa-fw-solid fa-user-lock">Pengaduan</i>
<?= $this->endSection()?>
        ...
        <div class="card-header">
          <?php
            if(session()->get('level')=='masyarakat'){
              ?>
             <a href="#" data-pengaduan="" class="btn btn-info" data-target="#modalPengaduan" data-toggle="modal"><i class="fas fa-fw fa-solid fa-user-plus"></i>Tambah Data Pengaduan</a>
      </div>
              <?php
             }
            ?>
           ...
           foreach ($pengaduan as $row) {
            ...
            <tr>
              ...
              <td>
                ...
                <a onclick="return confirm('Yakin Hapus Data???');" class="btn btn-danger" href="/pengaduan/hapus/<?=$row['id_pengaduan']?>"><i class="fa fa-trash"></i>Hapus</a>
                <?php
                  }else{
              ...
              if(!empty(session('level')) && session('level') !='masyarakat'){
                if($row['status'] == '0'){
                  ?>
                  <a class="btn btn-info" href="#" data-toggle="modal" data-target="#modalTanggapan" data-pengaduan="<?=$row['id_pengaduan']?>">Tanggapi</a>
                  <?php
                }else{
                  ?>
